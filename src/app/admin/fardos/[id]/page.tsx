...
export default async function EditarFardoPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <section className="p-6 space-y-6">
      <h1 className="text-2xl font-bold tracking-tight text-[#102016]">Editar Fardo</h1>
      <BasketForm initialData={initialData} redirectPath="/admin/fardos" />
    </section>
  )
}
