...
export default async function EditarCestaProntaPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <section className="p-6 space-y-6">
      <h1 className="text-2xl font-bold tracking-tight text-[#102016]">Editar Cesta Pronta</h1>
      <BasketForm initialData={initialData} redirectPath="/admin/cestas-prontas" />
    </section>
  )
}
